...
As it is now, it only works on 8 bit hex numbers. I should consider writing it to where the user sets it to
8,16,32,64 bit numbers  and parse a string (not implemented yet).
**********************************************************
ibase.f: convert between hexadecimal and decimal (hex numbers should be entered as 8 digit numbers with leading 0s (0X3 should be entered as 00000003)
*****************************************************************
rad.f: convert between radians and degrees
**********************************************************************
NOTE: any input that is DOUBLEPRECISION should be entered in engineering notaion (like 5.5D0 6.6D0) else
some calculations may be calculated as REAL not DOUBLEPRECISION. CHARACTER input should be enclosed in single quotes ' '. 
